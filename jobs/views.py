    ...
    if request.method == 'POST':
        ...
        if pesquisa:
            ...
            if len(pesquisa.strip()) == 0:
                ...
                query = Q(
                    Q(titulo__contains=pesquisa)|Q(descricao__icontains=pesquisa)
                )
...
def perfil(request):
    ...
    if request.method == "GET":
        ...
        if len(usuario) > 0:
            messages.add_message(request, constants.ERROR, 'Já existe um usuário cadastrado com este email.')
